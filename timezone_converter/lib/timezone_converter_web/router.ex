defmodule TimezoneConverterWeb.Router do
  ...
  import TimezoneConverterWeb.UserAuth
  ...
  scope "/", TimezoneConverterWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{TimezoneConverterWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", TimezoneConverterWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{TimezoneConverterWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", TimezoneConverterWeb do
    ...
    live_session :current_user,
      on_mount: [{TimezoneConverterWeb.UserAuth, :mount_current_user}] do
